...
public class GoodsPublishActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        simpleAdapter = new SimpleAdapter(this,
                imageItem, R.layout.gridview_item,
                new String[] { "itemImage"}, new int[] { R.id.grid_img});
        /*
            ...
            public void onItemClick(AdapterView<?> parent, View v, int position, long id)
            {
                if(position == 0) { //点击图片位置为+ 0对应0张图片
                    if( imageItem.size() == 10) { //第一张为默认图片
                        Toast.makeText(GoodsPublishActivity.this, "图片数9张已满", Toast.LENGTH_SHORT).show();
                    }
                    else {
                        Toast.makeText(GoodsPublishActivity.this, "添加图片", Toast.LENGTH_SHORT).show();
                        //选择图片
    ...
    protected void dialog(final int position) {
        AlertDialog.Builder builder = new AlertDialog.Builder(GoodsPublishActivity.this);
