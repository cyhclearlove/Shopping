...
public class registerActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //图片选择
        ImageView imageView = (ImageView) findViewById(R.id.register_headpick);
    ...
    public void onActivityResult(int requestCode, int resultCode, Intent data) {
        if (resultCode == RESULT_OK) {
            ...
            try {
                ...
                ImageView newpic = (ImageView) findViewById(R.id.register_headpick);
                /* 将Bitmap设定到ImageView */
                newpic.setImageBitmap(b);
                by = bitmapToByte(b);
                imageString = Base64.encodeToString(by,Base64.DEFAULT);
