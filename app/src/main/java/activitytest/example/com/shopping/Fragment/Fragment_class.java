...
import activitytest.example.com.shopping.Sort;
import activitytest.example.com.shopping.SortAdapter;
...
public class Fragment_class extends Fragment {
    ...
    public static Fragment_class newInstance(String param1, String param2) {
    ...
    void initSort(){
        for(int i=0;i<10;i++) {
            Sort sort = new Sort("电子产品", R.drawable.head2);
            sorts.add(sort);
        }
    }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        sortAdapter = new SortAdapter(sorts);
